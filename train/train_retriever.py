...
ds_name = r"F:\Repos\expository-text-generation\data\datasets\wiki_cs\content\wiki_cs"  # name of the dataset to use
col_name = "title"  # name of the column in dataset to use as input
final_name = r"F:\Repos\expository-text-generation\data\datasets\model\retriver"  # output dir and final name for model
